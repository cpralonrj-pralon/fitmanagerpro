...
const StudentProfile: React.FC<StudentProfileProps> = ({ onBack }) => {
  ...
  const studentTransactions = [
    ...
    { id: '3', description: 'Mensalidade - Plano Gold', studentName: 'Ana Silva', amount: 250.00, type: 'Receita' as const, category: 'Mensalidade', date: '2024-02-10', status: 'Pago' as const, paymentMethod: 'PIX' },
  ];
